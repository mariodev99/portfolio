...
export const GithubIcon = () => {
  ...
  export const LogoIcon = (props:any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="69" height="39" viewBox="0 0 99 59" fill="#fff"  {...props}>
  ...
  export const ArrowUp = (props:any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="black" {...props}>
      <path d="M12 5V19M12 5L18 11M12 5L6 11"  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
