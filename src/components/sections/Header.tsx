...
export const Header = () => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 justify-items-center items-center pt-20 md:pt-14 md:mt-10'>
      <div className='order-2 lg:order-1 flex justify-center'>
        <ImageProfileStandard/>
      </div>
      <div className={`${poppins.className} order-1 lg:order-2`}>
        <h1 className='text-4xl md:text-8xl font-black tracking-wide '>Luciano <br/> Mariotti </h1>
        <p className='mt-5 text-xl font-normal hidden lg:block'>Desarrollador front end que disfruta de diseñar y plasmar ideas creativas en la web.</p>
      </div>
  </div>
  )
}
