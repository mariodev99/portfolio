...
export const ProjectBox: React.FC<Props> = ({ title, image, url_site }) => {
  ...
  return (
    <motion.div
      onClick={handleClick}
      className="text-white overflow-hidden relative rounded-lg md:rounded-box lg:h-80 lg:w-80 h-48 w-48  "
    >
      <motion.div
      ...
      >
        ...
        <motion.div
          ...
          className="p-10 flex items-end relative z-40 w-full h-full bg-gradient-to-t from-black to-transparent"
        >
          {title}
        </motion.div>
      </motion.div>
