...
export default function SecundaryButton({
  ...
  return (
    <motion.button
      ...
      animate={{
        backgroundColor: buttonAnimation ? primary_color : secundary_color,
      }}
    >
      <motion.span animate={{ x: buttonAnimation ? 5 : -30 }}>
        <ArrowRight />
      </motion.span>
      <motion.span
        animate={{
          x: buttonAnimation ? 5 : -15,
          color: buttonAnimation ? secundary_color : primary_color,
        }}
      >
        {text}
      </motion.span>
      <motion.span
        ...
        animate={{
          opacity: buttonAnimation ? 0 : 1,
          scale: buttonAnimation ? 0 : 1,
        }}
